...
const Offers = () => {
  const offers = [
    {
      ...
      description: "Flat 25% OFF with Last Minute Booking",
      validTill: "25th Aug 2024",
      imgUrl: "/offer1.jpg",
    },
    {
      title: "First Flight",
      description: "Register and Get Discount on Booking First Flight with us*",
      validTill: "18th Aug 2024",
      imgUrl: "/offer2.jpg",
    },
    {
      title: "ITA Airways",
      description: "Enjoy Special Fares on Flights to All ITA Airways Networks",
  ...
  return (
    <div className="container mx-auto p-4 mt-2 ">
      ...
      >
        <h2 className="text-2xl text-center font-bold py-3">Best Offers</h2>
      ...
      >
        ...
        <div className="mb-4">
          ...
          <div className="mt-2">
            ...
            <button className="bg-white text-black px-4 py-2 border">
              Sep
            </button>
            <button className="bg-white text-black px-4 py-2 border rounded-r">
              Oct
            </button>
          </div>
        </div>
